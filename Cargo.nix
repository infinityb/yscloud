      ...
      "appliance-init" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "tracing-subscriber 0.2.15";
          }
        ];
